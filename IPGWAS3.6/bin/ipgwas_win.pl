...
Downloads::DownloadsExe::downloadPlinkWin($output_text);
Downloads::DownloadsExe::downloadGnuplotWin($output_text);

my $plink="$Bin/plink.exe";
my $gnuplot="$Bin/wgnuplot.exe";
...
sub Manual
{
system("$Bin/../manual/IPGWAS_Manual.pdf");
}

sub homepage
{
system("start http://sourceforge.net/projects/ipgwas/");
}
