...
Downloads::DownloadsExe::downloadPlinkMac($output_text);
Downloads::DownloadsExe::downloadGnuplotMac($output_text);

my $plink="$Bin/plink_mac";
my $gnuplot="$Bin/gnuplot_mac";
...
sub Manual
{
system("open $Bin/../manual/IPGWAS_Manual.pdf");
}

sub homepage
{
system("open http://sourceforge.net/projects/ipgwas/");
}
